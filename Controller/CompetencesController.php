...
class CompetencesController
{
    ...
    {
        $this->db = new \model\EntityCompetencesRepository; // permet de récuperer une connexion a la BDD qui se trouve dans le fichier EntityCompetencesRepository.php
    }    
   ...
   // echo '<pre>';print_r($r); echo '</pre>';
       ...
       $this->render('layout.php', 'donnees.php', array(
           'title'=>'Competences', // $title  dans l'index
   ...
   $id = isset($_GET['id']) ? $_GET['id'] : 'NULL';
    ...
    public function save($op)
    {
        ...
        $values = ($op == 'update') ? $this->db->select($id) : ''; // si on a envoyé un id dans l'URL, on l'envoi en argument de la méthode select() de EntityCompetencesRepository, cela permettra de selectionner Competences de l'employé pour les modification.
